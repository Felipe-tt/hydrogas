...
Para publicar na Google Play Store via Trusted Web Activity, siga o guia completo em [`TWA.md`](./TWA.md).

**Arquivos já preparados:**
- `public/privacy-policy.html` — Política de privacidade (obrigatória pela Play Store)
- `public/.well-known/assetlinks.json` — Verificação de domínio para TWA (preencher SHA-256 após gerar keystore)
