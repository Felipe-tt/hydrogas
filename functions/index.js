...
function buildEmailHtml({
  ...
  // ── ícones embutidos como PNG base64 — compatível com Gmail, Outlook, Apple Mail ──
  // SVGs via URL externa são bloqueados pelo Gmail. PNG base64 inline funciona em todos os clientes.
  const ICON_DROP_20 = 'data:image/png;base64,';
  const ICON_DROP_16 = 'data:image/png;base64,';
  const ICON_DROP_13 = 'data:image/png;base64,';
  const ICON_FIRE_20 = 'data:image/png;base64,';
  const ICON_FIRE_16 = 'data:image/png;base64,';
  const ICON_FIRE_13 = 'data:image/png;base64,';
  const ICON_BAG_20 = 'data:image/png;base64,';
  const ICON_BAG_16 = 'data:image/png;base64,';
  const ICON_BAG_13 = 'data:image/png;base64,';
  const iconDrop = (size) => {
    const src = size <= 13 ? ICON_DROP_13 : size <= 16 ? ICON_DROP_16 : ICON_DROP_20;
    return `<img src="${src}" width="${size}" height="${size}" alt="" border="0">`;
  }
  const iconFire = (size) => {
    const src = size <= 13 ? ICON_FIRE_13 : size <= 16 ? ICON_FIRE_16 : ICON_FIRE_20;
    return `<img src="${src}" width="${size}" height="${size}" alt="" border="0">`;
  }
  const iconBag = (size) => {
    const src = size <= 13 ? ICON_BAG_13 : size <= 16 ? ICON_BAG_16 : ICON_BAG_20;
    return `<img src="${src}" width="${size}" height="${size}" alt="" border="0">`;
  }
